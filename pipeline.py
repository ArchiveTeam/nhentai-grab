...
LUA_SHA1 = get_hash(os.path.join(CWD, 'nhentai.lua'))
    ...
    def realize(self, item):
        ...
        for item_name in item['item_name'].split('\0'):
            ...
            if item_type in types:
                wget_args.extend(['--warc-header', 'nhentai-{}: {}'.format(item_type, item_value)])
                wget_args.append('https://nhentai.net/{}/{}/'.format(types[item_type], item_value))
            else:
...
project = Project(
    title=TRACKER_ID,
    project_html='''
        <img class="project-logo" alt="Project logo" src="https://wiki.archiveteam.org/images/f/f6/Nhentai_icon_black_background.jpg" height="50px" title=""/>
        <h2>nhentai <span class="links"><a href="https://nhentai.net/">Website</a> &middot; <a href="http://tracker.archiveteam.org/nhentai/">Leaderboard</a> &middot; <a href="https://wiki.archiveteam.org/index.php/nhentai">Wiki</a></span></h2>
        <p>Archiving nhentai.</p>
    '''
)
